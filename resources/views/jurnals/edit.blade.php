...
<div class="form-container">
    ...
    <h1>Edit Absensi Perpustakaan</h1>

    <form method="POST" action="/jurnals/{{ $jurnal->id }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">Edit Absen</button>
